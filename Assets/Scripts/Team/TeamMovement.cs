...
namespace Team
{
  public class TeamMovement : MonoBehaviour
  {
    ...
    private void SetAnimation(float value)
    {
      ...
      // {
      //   _teamManager.AnimationStateChange?.Invoke(AnimationType.Firing);
      // }
      // else switch (value)
      // {
      //   case > 0:
      //     _teamManager.AnimationStateChange?.Invoke(AnimationType.RunRight);
      //     break;
      //   case < 0:
      //     _teamManager.AnimationStateChange?.Invoke(AnimationType.RunLeft);
      //     break;
      // }
    }
  }
